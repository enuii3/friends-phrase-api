...
class PhraseApiTest(APITestCase):
    ...
    def test_should_create_phrase(self):
        ...
        self.assertEqual(phrase.text_language.first().id, payload['text_language'])
        self.assertEqual(phrase.translated_word, payload['translated_word'])
        self.assertEqual(phrase.translated_word_language.first().id, payload['translated_word_language'])
